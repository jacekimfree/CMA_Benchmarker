...
for i in dirs:
    if os.path.isdir(os.getcwd() + "/" + i):
        ...
        if not os.path.exists(path + "/Disps_MP2_DZ"):
            os.mkdir(path + "/Disps_MP2_DZ")
        if os.path.exists(path + "/Disps_CCSD_DZ/DispsInit") and not os.path.exists(path + "/Disps_MP2_DZ/DispsInit"):
            sh.copytree(path + "/Disps_CCSD_DZ/DispsInit",path + "/Disps_MP2_DZ/DispsInit")
