...
class Projection(object):
    ...
    def run(self):
        ...
        Proj = block_diag(cyc_5str,unc,unc,unc,unc,unc,unc,unc,unc,unc,ch3_str,cyc_5ang,cc3_ang,unc,antisym_2,ch_ang,ch_ang,ch_ang,ch_ang,unc,antisym_2,ch3_ang,cyc_5tor,ch3_rot,unc,c2o_rot,unc,unc,unc,unc,unc)
