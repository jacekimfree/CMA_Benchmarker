...
# print(Manual_projection().get_proj("4.16"))
    ...
    def assign_irrep(self, tol=1e-5):
        ...
        for op in self.character_table.classes:
            ...
            for col, int_coord in enumerate(self.zmat):
                ...
                # if op == "σv(xz)":   # specify op to inspect
                #     print(f"Compare internal coords under operation: {op}. Internal coordinate idx: {col}.")
            ...
            # if op == "σv(xz)":
            #     proj_idx = 13
            #     print(f"Symmetry Operation {op} for Projection Matrix row {proj_idx}")
            #     print(f"Original   : {self.proj[proj_idx]}")
            #     print(f"Transformed: {trans_proj[proj_idx]}")
