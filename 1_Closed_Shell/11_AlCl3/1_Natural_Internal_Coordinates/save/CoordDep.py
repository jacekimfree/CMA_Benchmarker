...
from manual_projection import Projection
...
#
##Proj = block_diag(stretches_mat,inner_angles_mat,outer_angles_mat,outer_angles_mat,outer_angles_mat,outer_angles_mat,inner_angles_mat)
#
#
#""" 
...
project_obj = Projection(options)
project_obj.run()


Proj = project_obj.Proj
